...
export const HELP = {
  ...
  recPos: ['Recepción buena', 'Recepciones buenas / total de recepciones. Mide cuántas recepciones permiten construir un ataque en condiciones.'],
  saque: ['Saque A/E/T', 'Aces / errores / total de saques.'],
  efSaque: ['Eficacia de saque', '(Aces − errores) / total de saques. Positiva = el saque suma más puntos directos de los que regala.'],
